...
static this()
{
	...
	db.exec("CREATE TABLE IF NOT EXISTS `posts` (`id` INTEGER, `time`, `author`, `IP`, `title`, `text`, `moderated`, `verdict`, PRIMARY KEY(`id`, `time`))");
	...
	newPost      = db.prepare("INSERT INTO `posts`(`id`, `time`, `author`, `IP`, `title`, `text`, `moderated`, `verdict`) VALUES (?, ?, ?, ?, ?, ?, ?, ?)");
