...
static this()
{
	...
	db.exec("CREATE TABLE IF NOT EXISTS `posts` (`id` INTEGER, `time`, `user`, `userid`, `ip`, `title`, `text`, `moderated`, `verdict`, PRIMARY KEY(`id`, `time`))");
	...
	newPost      = db.prepare("INSERT INTO `posts`(`id`, `time`, `user`, `userid`, `ip`, `title`, `text`, `moderated`, `verdict`) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)");
